    ...
    <el-container style="border: 1px solid #eee">
      <el-aside width="200px" style="background-color: rgb(238, 241, 246);height: 100%">
        <el-menu :default-openeds="['1']">
          ...
          <el-submenu index="2">
            <template slot="title"><i class="el-icon-menu"></i>二</template>
          ...
          <el-submenu index="3">
            <template slot="title"><i class="el-icon-setting"></i>三</template>
          </el-submenu>
        </el-menu>
      </el-aside>
      ...
      <el-container>
        ...
        <el-main>
          ...
          <el-table :data="tableData" border stripe>
            ...
            <el-table-column label="课程封面" prop="headurl">
...
<el-form-item label="修改封面" prop="chairImg">
                    <el-upload
